...
export const TopBar: React.FC<TopBarProps> = ({
  ...
  return (
    <header
      id="coohom-topbar"
      className="absolute top-0 left-0 right-0 z-30 px-4 py-3 flex items-center justify-between pointer-events-none select-none bg-gradient-to-b from-neutral-950/80 via-neutral-950/40 to-transparent"
    >
      {/* Left: Project Branding & Title */}
      <div className="flex items-center gap-3 pointer-events-auto">
        {/* Coohom-style Logo Mark */}
        <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 p-0.5 shadow-lg shadow-blue-500/25 flex items-center justify-center">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-sm font-bold text-white tracking-tight drop-shadow">
              {project.title}
            </h1>
          ...
          <p className="text-[11px] text-neutral-300 font-medium drop-shadow flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-2 pointer-events-auto">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-600/90 hover:bg-blue-600 text-white text-xs font-semibold backdrop-blur-md shadow-lg shadow-blue-900/30 transition-colors cursor-pointer"
        ...
        <button
          ...
          className="p-2 rounded-full bg-neutral-900/70 hover:bg-neutral-900 text-neutral-300 hover:text-white backdrop-blur-md border border-white/10 shadow-lg transition-colors"
